...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        {
            user && <li><NavLink to="/dashboard" className='text-base font-normal whitespace-nowrap mx-1'>Dashboard</NavLink></li>
        }
        ...
        <li>
            {
                user ? <button className='text-base font-normal whitespace-nowrap mx-1' onClick={logout}>Logout</button>
                    : <NavLink to="/login" className='text-base font-normal whitespace-nowrap mx-1'>Login</NavLink>
            }
        </li>
        <li>
    ...
    return (
        <div className="navbar fixed top-0 left-0 z-50 px-5 xl:px-24 bg-base-100">
            <div className="navbar-start w-full justify-between">
                <label htmlFor="dashboard-menu" className="btn btn-ghost drawer-button lg:hidden">
